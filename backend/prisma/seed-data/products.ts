...
export const products: SeedProduct[] = [
  ...
  { name: "Stockfish", category: "PROTEIN", unit: "kg", pricePerUnit: 8000, stockQty: 80, storageMethod: "Store in a cool, dry place, or freeze once soaked.", shelfLifeDays: 180, prepInstructions: "Soak overnight before use to soften." },
  ...
  { name: "Crayfish (Ground)", category: "PROTEIN", unit: "kg", pricePerUnit: 7000, stockQty: 80, storageMethod: "Store in an airtight container; refrigerate for longer freshness.", shelfLifeDays: 120 },
  ...
  { name: "Egusi Seeds (Ground)", category: "PROTEIN", unit: "kg", pricePerUnit: 4500, stockQty: 100, storageMethod: "Store in an airtight container in a cool, dry place.", shelfLifeDays: 180 },
  ...
  { name: "Ogbono Seeds (Ground)", category: "PROTEIN", unit: "kg", pricePerUnit: 6000, stockQty: 80, storageMethod: "Store in an airtight container in a cool, dry place.", shelfLifeDays: 180 },
  ...
  { name: "Beans (Honey/Oloyin)", category: "PROTEIN", unit: "kg", pricePerUnit: 2200, stockQty: 150, storageMethod: "Store in an airtight container in a cool, dry place.", shelfLifeDays: 270 },
  { name: "Peeled Beans", category: "PROTEIN", unit: "kg", pricePerUnit: 2500, stockQty: 100, storageMethod: "Store in an airtight container; refrigerate once soaked.", shelfLifeDays: 180 },
  ...
  { name: "Eggs", category: "PROTEIN", unit: "piece", pricePerUnit: 150, stockQty: 1000, storageMethod: "Refrigerate.", shelfLifeDays: 21 },
  ...
  { name: "Ponmo (Cow Skin)", category: "PROTEIN", unit: "kg", pricePerUnit: 3500, stockQty: 80, storageMethod: "Freeze if not used within 2 days.", shelfLifeDays: 3 },
